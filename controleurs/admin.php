...
if (isset($_SESSION['id'])) {
    ...
    if (isset($_POST['addClient'])) {
        ...
        insertClient($auth,$_POST['password'], $_POST['mail'], $_POST['adresse'],$_POST['societe'], $_POST['accesSociete']);
    }
    ...
    if (isset($_GET['act'])) {
        if ($_GET['act'] == "modifyclient") {
            if (isset($_POST['modifyClient'])) {
                ...
                updateClient($auth, $_GET['param1'], $_POST['mail'], $_POST['adresse'],$_POST['societe'], $_POST['password'], $_POST['accesSociete']);
            }
